...
//Suite à notre décision d’éliminer tout échappement automatique 
//en entrée d’un script PHP, il faudra penser systématiquement à 
//traiter avec la fonction mysql_real_escape_string() les chaînes à insérer dans MySQL.
